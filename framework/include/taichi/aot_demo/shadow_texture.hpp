...
class ShadowTexture {
 ...
 private:
  ...
  void copy_from_vulkan_(const ti::Image &src);
  void copy_from_cpu_(const ti::Image &src);
  void copy_from_cuda_(const ti::Image &src);
  void copy_from_opengl_(const ti::Image &src);
};

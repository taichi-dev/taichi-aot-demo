...
class ShadowBuffer {
 ...
 private:
  ...
  void copy_from_vulkan_(const ti::Memory &src);
  void copy_from_cpu_(const ti::Memory &src);
  void copy_from_cuda_(const ti::Memory &src);
  void copy_from_opengl_(const ti::Memory &src);
};

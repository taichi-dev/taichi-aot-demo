...
@ti.kernel
def initialize(boundary_box: ti.types.ndarray(ndim=1), spawn_box: ti.types.ndarray(ndim=1), N: ti.types.ndarray(ndim=1)):
...
@ti.kernel
def initialize_particle(pos: ti.types.ndarray(ndim=1), vel: ti.types.ndarray(ndim=1), spawn_box: ti.types.ndarray(ndim=1), N: ti.types.ndarray(ndim=1), gravity: ti.types.ndarray(ndim=0)):
...
@ti.kernel
def update_force(
    pos: ti.types.ndarray(ndim=1), vel: ti.types.ndarray(ndim=1), den: ti.types.ndarray(ndim=1), pre: ti.types.ndarray(ndim=1), acc: ti.types.ndarray(ndim=1), gravity: ti.types.ndarray(ndim=0)
):
    for i in range(particle_num):
        acc[i] = gravity[None]
        for j in range(particle_num):
